...
$authenticated=1;
$newHeader="location:raga.php?msg=";
...
$add1 = "INSERT INTO raga(band_name,genre,place,no1,no2,no3,no4,no5,no6,no7,no8,history,link,name) values ('$band','$genre','$place','$no1','$no2','$no3','$no4','$no5','$no6','$no7','$no8','$history','$link','$username')";
...
mysql_close($db);
header("location:raga.php?msg=$msg");
exit();
}
